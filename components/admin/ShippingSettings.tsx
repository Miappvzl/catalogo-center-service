            ...
            <div>
                ...
                <div className="flex-1 space-y-6">
                    ...
                    <div className="space-y-3">
                        ...
                        {/* 🚀 CONTROL DE ENVÍO GRATUITO */}
                        <div className="bg-neutral-50/50 p-4 rounded-xl border border-neutral-200/60 mb-4">
                            <div
                                className="flex items-center justify-between cursor-pointer"
                                onClick={() => {
                                    setIsDirty(true);
                                    setConfig(prev => ({ ...prev, national_shipping_is_free: !prev.national_shipping_is_free }));
                                }}
                            >
                                <div className="space-y-1 pr-4">
                                    <p className="font-bold text-xs text-neutral-900 flex items-center gap-2">
                                        <Truck size={16} className="text-cyan-600" /> Envío Nacional Gratuito
                                    </p>
                                    <p className="text-[10px] text-neutral-500 leading-relaxed">
                                        Asume el costo de los envíos por agencia. El Checkout mostrará "(Envío Gratis)" en lugar de "(Cobro en Destino)".
                                    </p>
                                </div>
                                <div className={`w-10 h-5.5 rounded-full border flex items-center px-0.5 shrink-0 transition-colors duration-200 ${config.national_shipping_is_free ? 'bg-cyan-600 border-transparent justify-end' : 'bg-neutral-100 border-neutral-200 justify-start'}`}>
                                    <motion.div layout transition={{ type: "spring", stiffness: 600, damping: 30 }} className="w-4 h-4 rounded-full bg-white shadow-xs" />
                                </div>
                            </div>
                        </div>
