...
const BcvTicker = () => (
  <div className="bg-black text-white text-[10px] font-bold py-2 overflow-hidden border-b border-gray-800 z-50 relative">
    <div className="whitespace-nowrap flex animate-ticker w-max">
      {[...Array(6)].map((_, i) => (
        <div key={i} className="flex items-center gap-10 mx-6">
          ...
          <span className="text-gray-400">CUPO LIMITADO</span>
          <span className="text-white">ACCESO BETA</span>
...
// --- FORMULARIO DE LISTA DE ESPERA (NUEVO) ---
const WaitlistForm = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Simulación de carga para UX
        setTimeout(() => {
            const message = ` *SOLICITUD DE ACCESO PREZISO*\n\nHola, quiero unirme a la lista de espera.\n\n *Nombre:* ${form.name}\n *Instagram:* ${form.instagram}\n *Correo:* ${form.email}\n\nQuedo atento para asegurar mi cupo.`
            
            // Reemplaza este número con el tuyo real
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full max-w-md bg-white border border-gray-200 p-2 rounded-2xl shadow-xl flex flex-col gap-2 mt-8 relative z-20">
            <div className="absolute -top-3 left-4 bg-green-100 text-green-700 px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider border border-green-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 p-2">
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="w-full bg-gray-50 border border-transparent focus:bg-white focus:border-gray-200 rounded-xl pl-9 pr-3 py-3 text-sm outline-none transition-all font-medium text-gray-900"
                    />
                </div>
                <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row gap-2 px-2 pb-2">
                ...
                <button 
                    type="submit"
                    disabled={loading}
                    className="bg-black text-white px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-wider hover:bg-gray-800 transition-all flex items-center justify-center gap-2 whitespace-nowrap shadow-lg disabled:opacity-70 disabled:cursor-not-allowed"
                >
                    {loading ? '...' : <>Unirme <ArrowRight size={14}/></>}
                </button>
            </div>
            <p className="text-[10px] text-gray-400 text-center pb-2 flex items-center justify-center gap-1">
                <Lock size={10}/> Tus datos se envían encriptados a nuestro WhatsApp oficial.
            </p>
        </form>
    )
}
...
const PainAlert = () => (
  <motion.div 
    ...
    className="absolute -top-6 -right-6 z-20 bg-red-50 border border-red-100 p-4 rounded-2xl shadow-xl max-w-[200px] hidden md:block"
  >
    <div className="flex items-start gap-3">
      <AlertTriangle size={16} className="text-red-500 shrink-0 mt-0.5" />
      <div>
        <p className="text-[10px] font-bold text-red-800 leading-tight mb-1">ALERTA DE MARGEN</p>
...
const InteractiveDemo = () => {
    ...
    return (
        <div className="relative group w-full max-w-[340px] mx-auto perspective-1000">
             <PainAlert />
             {/* Glow */}
            <div className="absolute -inset-1 bg-gradient-to-tr from-gray-200 to-gray-100 rounded-[2rem] blur-xl opacity-50"></div>
            
            <div className="relative bg-white rounded-[1.8rem] border border-gray-200 shadow-2xl overflow-hidden p-6">
                {/* Header Mockup */}
                <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-black text-gray-900">Preziso Store</p>
                        </div>
                    </div>
                    <div className="bg-green-100 text-green-700 px-2.5 py-1 rounded-lg text-[10px] font-bold flex items-center gap-1">
                ...
                <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-gray-50 rounded-xl border border-gray-100 flex items-center justify-center text-2xl">👟</div>
                    <div>
                        <p className="text-sm font-bold text-gray-900">Nike Air Force 1</p>
                        <p className="text-[11px] text-gray-500">Blanco • Talla 42</p>
                    </div>
                    <div className="ml-auto font-black text-sm text-gray-900">${price}</div>
                </div>

                {/* Selectores */}
                <div className="bg-gray-50 p-1 rounded-xl grid grid-cols-2 gap-1 mb-6">
                    <button 
                        onClick={() => setMethod('pago_movil')}
                        className={`py-2 rounded-lg text-[10px] font-bold transition-all ${method === 'pago_movil' ? 'bg-white text-black shadow-sm ring-1 ring-black/5' : 'text-gray-400 hover:text-gray-600'}`}
                    >
                        Pago Móvil (Bs)
                    </button>
                    <button 
                        onClick={() => setMethod('zelle')}
                        className={`py-2 rounded-lg text-[10px] font-bold transition-all ${method === 'zelle' ? 'bg-green-500 text-white shadow-md' : 'text-gray-400 hover:text-gray-600'}`}
                    >
                        Zelle (-${penalty})
                    </button>
                </div>
        ...
        <section className="py-24 bg-white border-t border-gray-100">
            <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
                <div className="order-2 lg:order-1">
                    <div className="relative bg-gray-50 border border-gray-200 rounded-[2.5rem] p-8 md:p-12 overflow-hidden">
                        {/* Fake Browser Header */}
                        ...
                        <div className="flex gap-8">
                            ...
                            <motion.div 
                                ...
                                className={`w-32 h-32 md:w-48 md:h-48 rounded-2xl flex items-center justify-center text-4xl shadow-inner ${color === 'black' ? 'bg-gray-900 text-white' : (color === 'green' ? 'bg-green-600 text-white' : 'bg-white border border-gray-200 text-black')}`}
                            >
                                👟
                            </motion.div>
                            ...
                            <div className="flex-1 space-y-6">
                                <div>
                                    <h4 className="font-black text-xl mb-1">Urban Kicks V2</h4>
                                    <p className="text-sm text-gray-500 font-mono">$120.00 USD</p>
                                </div>
                                    ...
                                    <div className="flex gap-2">
                                        {['black', 'white', 'green'].map(c => (
                                            <button 
                                                key={c} 
                                                onClick={() => setColor(c)}
                                                className={`w-8 h-8 rounded-full border-2 transition-all ${color === c ? 'border-black scale-110' : 'border-transparent opacity-50 hover:opacity-100'} ${c === 'black' ? 'bg-black' : (c === 'green' ? 'bg-green-600' : 'bg-white border-gray-200 shadow-sm')}`}
                                            />
                                        ))}
                                    </div>
                                </div>
                                    ...
                                    <div className="flex gap-2">
                                        {['40', '41', '42'].map(s => (
                                            <button 
                                                key={s}
                                                onClick={() => setSize(s)}
                                                className={`w-8 h-8 rounded-lg text-xs font-bold transition-all ${size === s ? 'bg-black text-white' : 'bg-white border border-gray-200 text-gray-500 hover:border-gray-400'}`}
                                            >
                                                {s}
                                            </button>
                                        ))}
                ...
                <div className="order-1 lg:order-2">
                    <span className="inline-block px-3 py-1 rounded-full bg-black/5 text-black text-[10px] font-bold uppercase tracking-widest mb-6">
                        Gestión de Catálogo V2
                    </span>
                    <h2 className="text-4xl md:text-5xl font-black tracking-tight mb-6">
                        No vendas productos.<br/>
                        <span className="text-gray-400">Vende opciones.</span>
                    </h2>
                    ...
                    <ul className="space-y-4">
                        <li className="flex items-center gap-3 font-medium">
                            <CheckCircle2 size={18} className="text-black"/> Control de Stock por Talla/Color
                        </li>
                        <li className="flex items-center gap-3 font-medium">
                            <CheckCircle2 size={18} className="text-black"/> Fotos específicas por Variante
                        </li>
                        <li className="flex items-center gap-3 font-medium">
                            <CheckCircle2 size={18} className="text-black"/> Precios distintos según material
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div key={i} className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                            ...
                            <AnimatePresence>
                                {open === i && (
                                    ...
                                    >
                                        <p className="p-6 pt-0 text-gray-500 leading-relaxed text-sm">
                                            {faq.a}
                                        </p>
                                    </motion.div>
                                )}
...
const Testimonials = () => (
    <section className="py-24 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
            <h2 className="text-3xl font-black mb-16">Ya confían en nosotros</h2>
            <div className="grid md:grid-cols-3 gap-8">
                {[
                    ...
                    <div key={i} className="p-8 rounded-[2rem] bg-gray-50 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
...
export default function LandingClient() {
   ...
   const scrollToForm = () => {
    const formElement = document.getElementById('formulario-registro') // Busca esta etiqueta
    if (formElement) {
        formElement.scrollIntoView({ behavior: 'smooth', block: 'center' })
    } else {
        console.log("No encontré el formulario") // Para depurar
    }
}
    ...
    return (
        <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-black selection:text-white overflow-x-hidden">
            ...
            {/* NAVBAR */}
            <nav className="sticky top-0 w-full z-40 bg-white/80 backdrop-blur-xl border-b border-gray-100">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        <a href="#features" className="text-xs font-bold text-gray-500 hover:text-black uppercase tracking-wide">Características</a>
                        <a href="#demo" className="text-xs font-bold text-gray-500 hover:text-black uppercase tracking-wide">Demo</a>
                    </div>

                    <div className="flex items-center gap-4">
                        
                        <button onClick={scrollToForm} className="bg-black text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-wider hover:bg-gray-800 transition-all shadow-lg flex items-center gap-2">
            ...
            <section className="pt-24 pb-20 lg:pt-32 lg:pb-32 relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none">
                    <div className="absolute top-[-10%] right-[-10%] w-[600px] h-[600px] bg-gray-100 rounded-full blur-[100px] opacity-70"></div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center">
                    <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-black text-gray-500 uppercase tracking-widest">Sistema Operativo para Venezuela</span>
                        </motion.div>
                        ...
                        >
                            ...
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-black to-gray-500">Automático.</span>
                        </motion.h1>
                        ...
                        <motion.p 
                            ...
                            className="text-xl text-gray-500 mb-6 leading-relaxed font-medium max-w-xl"
                        >
            ...
            <section id="features" className="py-24 bg-gray-50 border-t border-gray-200">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-black mb-4">El fin del caos manual.</h2>
                        <p className="text-gray-500 text-lg">Reemplazamos tu Excel y tu calculadora.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(200px,auto)]">
                        {/* Card BCV */}
                        <div className="md:col-span-2 bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-lg relative overflow-hidden group">
                        ...
                        {/* Card CRM */}
                        <div className="md:row-span-2 bg-[#0A0A0A] text-white rounded-[2.5rem] p-10 relative overflow-hidden flex flex-col justify-between group shadow-2xl">
                        ...
                        {/* Card Web */}
                        <div className="bg-white rounded-[2.5rem] p-10 border border-gray-100 shadow-lg group hover:-translate-y-1 transition-transform">
                             <div className="w-14 h-14 bg-blue-50 rounded-2xl flex items-center justify-center mb-6 text-blue-600">
                                <Globe size={28} />
                            </div>
                            <h3 className="text-xl font-black mb-2">Tu Web .app</h3>
            ...
            <footer className="py-12 bg-white border-t border-gray-100 text-center">
                 <div className="flex items-center justify-center gap-2 font-black text-xl mb-6 opacity-40">
