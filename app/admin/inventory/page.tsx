...
export default function InventoryPage() {
  ...
  const saveStock = async (row: InventoryItem) => {
    ...
    // UX/Logic: Si el input quedó vacío (''), asumimos 0 para la base de datos
    ...
    try {
        ...
        const Toast = Swal.mixin({
            ...
            customClass: { popup: 'bg-black text-white rounded-xl text-xs font-bold' }
        })
                                                ...
                                                <div className="flex justify-center">
                                                    <div className="flex items-center gap-2">
                                                        <input 
                                                            ...
                                                            className={`w-16 md:w-20 text-center font-mono font-bold text-sm md:text-base py-2 rounded-xl border transition-all outline-none ${
                                                                isPending 
