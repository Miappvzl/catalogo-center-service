        ...
        <div className="min-h-screen bg-[#F8F9FA] pb-20 font-sans text-gray-900 flex flex-col">
            ...
            <div className="bg-white/80 backdrop-blur-md border-b border-gray-200 sticky top-0 z-30 px-4 md:px-8 py-4 flex justify-between items-center transition-all">
                <div className="flex items-center gap-4">
                    <Link href="/admin" className="p-2 bg-white border border-gray-200 hover:border-black hover:bg-gray-50 rounded-full transition-all group shrink-0">
            ...
            <div className="w-full max-w-[100vw] overflow-x-hidden flex-1">
                <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 space-y-6">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 items-stretch md:items-center w-full">
                        ...
                        <div className="flex bg-gray-50 border border-gray-200 p-1.5 rounded-full overflow-x-auto no-scrollbar w-full md:w-auto max-w-full">
                            {[
                                { id: 'all', label: 'Todos' },
                                                ...
                                                <tr key={item.rowId} className="group hover:bg-gray-50/50 transition-colors border-b border-gray-100 last:border-0">
                                                            ...
                                                            <div className="min-w-0">
                                                                ...
                                                                <div className="flex items-center gap-2 mt-1.5 md:hidden">
                                                                    <div className="flex items-center gap-1.5 px-1.5 py-1 bg-gray-50 border border-gray-200 rounded-md">
                                                                        <span className="w-2.5 h-2.5 rounded-full border border-gray-200 shrink-0" style={{ background: item.hex }}></span>
                                                    ...
                                                    <td className="p-4 md:p-6 hidden md:table-cell align-middle">
                                                        <div className="flex items-center gap-2">
                                                            <div className="px-3 py-1.5 rounded-lg border border-gray-200 bg-gray-50 flex items-center gap-2 max-w-[120px]">
                                                                <span className="w-3 h-3 rounded-full border border-gray-200 shrink-0" style={{ background: item.hex }}></span>
                                                    ...
                                                    <td className="p-4 md:p-6 text-right align-middle">
                                                        <div className="flex justify-end items-center gap-4">
                                                            <div className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-wide border ${statusColor} shrink-0`}>
                                                                <StatusIcon size={12} strokeWidth={2.5} /> <span className="hidden sm:inline">{statusText}</span>
                                                            </div>
                                                            <Link href={`/admin/product/edit/${item.productId}`} className="text-gray-400 hover:text-black transition-colors bg-gray-50 hover:bg-gray-100 p-2 rounded-lg border border-transparent hover:border-gray-200 shrink-0" title="Editar producto completo">
