                                        ...
                                        <div className="flex overflow-x-auto no-scrollbar gap-2 pb-1 w-full max-w-full">
                                            {['pending', 'paid', 'shipped', 'cancelled'].map(status => (
                                                <button
                                                    ...
                                                    className={`shrink-0 px-5 py-2.5 rounded-[var(--radius-btn)] text-xs font-bold uppercase tracking-wide transition-all flex items-center justify-center gap-2 ${selectedOrder.status === status
