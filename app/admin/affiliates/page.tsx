...
import { Copy, Wallet, TrendingUp, Users, CheckCircle2, AlertCircle } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-8 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
          <div className="flex justify-between items-start mb-6">
            ...
            {!hasPaymentDetails && <span className="flex items-center gap-1 text-[10px] font-bold bg-red-50 text-red-600 px-2 py-1 rounded-lg uppercase tracking-widest"><AlertCircle size={12}/> Faltan Datos</span>}
          </div>
