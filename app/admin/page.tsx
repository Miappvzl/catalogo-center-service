    ...
    switch (status) {
       case 'pending':
            return {
                ...
                iconWrapper: 'bg-yellow-50 text-yellow-700 group-hover:bg-yellow-500 group-hover:text-white active:bg-yellow-600',
        ...
        case 'paid':
            return {
                ...
                iconWrapper: 'bg-emerald-50 text-emerald-600 group-hover:bg-emerald-500 group-hover:text-white active:bg-emerald-600',
        ...
        case 'cancelled':
            return {
                ...
                iconWrapper: 'bg-red-50 text-red-600 group-hover:bg-red-500 group-hover:text-white active:bg-red-600',
        ...
        default: // Enviado / Otros
            return {
                ...
                iconWrapper: 'bg-[#f6f6f6] text-gray-900 group-hover:bg-black group-hover:text-white active:bg-gray-800',
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                    ...
                    >
                        <div className="flex justify-between items-start relative z-10">
                            ...
                            <div className={`w-11 h-11 rounded-[var(--radius-btn)] flex items-center justify-center shrink-0 transition-all duration-500 ease-out ${lowStockCount > 0
        ...
        return (
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div className={`w-11 h-11 rounded-[var(--radius-btn)] transition-all duration-300 ease-out flex items-center justify-center shrink-0 ${theme.iconWrapper}`}>
                ...
                <div className="text-right flex flex-col items-end">
                    ...
                    <div className="flex items-center gap-1.5 mt-1.5">
                        ...
                        <span className={`text-[9px] font-bold uppercase tracking-widest ${theme.label}`}>
                            {theme.text}
                        </span>
                    </div>
                </div>
