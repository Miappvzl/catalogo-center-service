                        ...
                        <div className="aspect-[4/5] md:aspect-square bg-gray-50/80 rounded-3xl md:rounded-[2.5rem] relative overflow-hidden group border border-gray-100 shadow-sm flex items-center justify-center">
                            {currentImage ? (
                                <Image
                                    ...
                                    className="object-contain p-6 md:p-12 mix-blend-multiply transform-gpu transition-transform duration-700 ease-out group-hover:scale-105"
                                />
                            ) : (
                                    ...
                                    <div className="flex flex-wrap gap-2.5">
                                        {availableColors.map((c: any) => (
                                            <button
                                                ...
                                                className={`w-11 h-11 md:w-14 md:h-14 rounded-full shadow-sm transition-all duration-300 relative transform-gpu flex-shrink-0 ${selectedColor === c.name
                                        ...
                                        <div className="flex flex-wrap gap-2 md:gap-3">
                                            {availableSizes.map((v) => (
                                                <button
                                                    ...
                                                    className={`py-3 px-5 min-w-[3.5rem] md:min-w-[4.5rem] rounded-xl text-sm font-black border transition-all duration-200 transform-gpu active:scale-95 ${selectedSize === v.size
